...
class Cron_Tarrif_model extends CI_Model {
	...
	function getDriverPayment(){
		...
		T.trip_day_night_type_id as day_or_night,T.id as trip_id, T.driver_id as driver_id, T.distance_in_km_from_app as Distance_app,
		...
		LEFT JOIN tariffs TF ON TF.id=T.tariff_id WHERE T.trip_status_id='.TRIP_STATUS_TRIP_COMPLETED;
